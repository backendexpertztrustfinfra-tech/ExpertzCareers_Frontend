...
import SavedCandidatesView from "../Components/Admin/Candidate/SavedCandidatesView"
...
const Admin = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "Job":
        return <JobTabs setActiveTab={updateTab} setSelectedJob={setSelectedJob} />
      case "JobPost":
        return <PostJobPage />
      case "Candidate":
        return <CandidateView selectedJob={selectedJob} />
      case "Saved Candidates":
        return <SavedCandidatesView />
      case "Database":
        return (
          <DatabaseView hasSubscription={userProfile?.subscriptionActive} onShowPlan={() => updateTab("Credits")} />
        )
      case "Credits":
      ...
      case "Profile":
        return (
          <ProfileEditor
            ...
            onUpdate={(newData) => setUserProfile((prev) => ({ ...prev, ...newData }))}
          />
        )
      default:
        return <StatCards setActiveTab={updateTab} />
