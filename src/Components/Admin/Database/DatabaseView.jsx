...
            const experienceArray = parseQualOrExp(candidate.Experience);
...
// --- UPDATED: handleSaveCandidate with Toast Notifications ---
  const handleSaveCandidate = async (candidateId) => {
    const candidateToSave = visibleCandidates.find((c) => c._id === candidateId);
