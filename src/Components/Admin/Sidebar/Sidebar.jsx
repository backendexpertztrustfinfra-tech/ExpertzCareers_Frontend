...
const Sidebar = ({ activeTab, setActiveTab, collapsed, setCollapsed }) => {
  ...
  const tabs = [
    ...
    { icon: <FaDatabase />, label: "Saved Candidates" },
  ...
  return (
    <>
      {/* Mobile Overlay */}
      {!collapsed && window.innerWidth < 768 && <div className="fixed inset-0 bg-black/40 z-30"></div>}
            ...
            {!collapsed && (
              <div className="flex flex-col w-full min-w-0">
                ...
                <div className="flex items-center gap-2 text-sm sm:text-base text-gray-700 truncate mt-1">
                  ...
                  <span className="truncate">{userProfile?.user?.useremail || "No Email"}</span>
                </div>
                ...
                <div className="flex items-center gap-2 text-sm sm:text-base text-gray-600 truncate mt-0.5">
                  ...
                  <span className="truncate">{userProfile?.user?.recruterPhone || "No Phone"}</span>
                </div>
              </div>
            )}
          </div>
