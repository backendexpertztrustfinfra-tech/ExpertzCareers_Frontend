...
const JobCard = ({ job, showActions = true, onJobClick }) => {
  ...
  const normalized = {
    ...
    title:
      job.title ||
      job.jobTitle ||
      (job.raw && (job.raw.jobTitle || job.raw.title)),
    company:
      job.company ||
      job.companyName ||
      (job.raw && (job.raw.companyName || job.raw.company)),
    location:
      job.location ||
      job.jobLocation ||
      job.address ||
      (job.raw && job.raw.location),
    ...
    description:
      job.description ||
      job.jobDescription ||
      (job.raw && (job.raw.description || job.raw.jobDescription)),
    category:
      job.category ||
      job.jobCategory ||
