...
//   const isAdminRoute = location.pathname.startsWith("/admin");
//   const isJobseeker = user?.type === "jobseeker"; // ✅ Only jobseeker sees icons
...
//         {/* Right Section */}
//         <div className="flex items-center gap-4">
//           {/* Jobseeker-only icons */}
//           {!isAdminRoute && isJobseeker && (
//             <>
//                   <button
//       title="Notification"
//       type="button"
...
//       {/* Mobile Jobseeker Menu */}
//       {!isAdminRoute && isMobile && mobileOpen && isJobseeker && (
//         <div className="lg:hidden bg-white border-t border-gray-200 shadow-md">
//           <div className="flex flex-col px-6 py-4 gap-4">
//             {navItems.map((item, idx) => {
//               const hasMega = ["Jobs", "Companies", "Services"].includes(
